...
function [optimal_sumrate2, optimal_sumpow2, optimal_obj2, Pow, Rate, LoopEE] = FUNC_multiSAT_OPT(NumUE_in_SAT, IdClusUE, lambda_ref, Beta, Rho, sigma_u, ...
...
%     fprintf("The optimal tau = %f \n", tau_ref2);
    ...
    LoopEE(iter_tau) = optimal_sumrate2/(sum(Pow_cir_overline)+optimal_sumpow2);
